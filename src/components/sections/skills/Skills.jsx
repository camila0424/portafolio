  ...
  return (
    ...
    >
      <div className="max-w-7xl w-full flex flex-col items-center">
        <p className="text-2xl italic bg-gradient-to-r from-purple-700 via-indigo-400 to-purple-700 bg-clip-text text-transparent mt-3 mb-3">
          Estas son las{" "}
        ...
        <p className="text-base italic text-blue-300 mb-5">
          Toca cada una de ellas para ver su descripción
        </p>
